...
if "ARTIFACTORY_TOKEN" in os.environ:
    ...
    AUTH_STRING = '-H "X-JFrog-Art-Api:{}"'.format(ARTIFACTORY_TOKEN)
else:
    ARTIFACTORY_LOGIN = os.environ["ARTIFACTORY_LOGIN"]
    ARTIFACTORY_PASSWORD = os.environ["ARTIFACTORY_PASSWORD"]
    AUTH_STRING = "-u{}:{}".format(ARTIFACTORY_LOGIN, ARTIFACTORY_PASSWORD)
